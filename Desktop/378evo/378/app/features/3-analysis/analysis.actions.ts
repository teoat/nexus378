...
import { generateAuditNarrative } from "./ai-flows/generate-audit-narrative";
...
export async function runFullForensicAnalysis(input: FullAnalysisInput) {
    ...
    if (anomalies.length > 0) {
        summaryPromises.push(
            generateAuditNarrative({ anomalies, analysisSummary: "See detailed findings below.", isCostOptimized: mode === 'cost-optimized' })
