...
class EncryptionService:
    ...
    def generate_user_key_pair(
        self, user_id: str, master_key_id: str
    ) -> Tuple[str, str]:
    ...
    def encrypt_file(
        self, file_path: str, encryption_key: bytes, output_path: Optional[str] = None
    ) -> str:
    ...
    def verify_data_integrity(
        self, data: bytes, expected_hash: str, algorithm: str = "SHA256"
    ) -> bool:
