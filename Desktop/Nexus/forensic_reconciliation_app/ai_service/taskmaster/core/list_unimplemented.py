...
def main():
    ...
    if completed_tasks:
        ...
        for todo in completed_tasks:
            ...
            print(f"    Status: {todo['status']} | Progress: {todo['progress']}% | MCP: {todo['mcp_status']}")
    ...
    if unimplemented_tasks:
        ...
        for todo in unimplemented_tasks:
            print(f"  • {todo['id']}: {todo['name']}")
            print(f"    Priority: {todo['priority']} | Duration: {todo['estimated_duration']}")
            print(f"    Status: {todo['status']} | Progress: {todo['progress']}% | MCP: {todo['mcp_status']}")
            print(f"    Agent: {todo['assigned_agent']}")
