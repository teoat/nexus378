...
class TestDuckDBSetup(unittest.TestCase):
    ...
    def test_schema_creation(self):
        ...
        expected_schemas = [
            "raw_data", "staging", "processed", "analytics",
            "audit", "metadata", "reconciliation", "performance"
        ]
        
        for schema in expected_schemas:
            mock_connection.execute.assert_any_call(f"CREATE SCHEMA IF NOT EXISTS {schema}")
