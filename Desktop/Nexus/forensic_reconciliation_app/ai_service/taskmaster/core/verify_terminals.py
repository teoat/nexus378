...
def verify_collective_workers():
        ...
        if result.returncode == 0:
            ...
            if collective_processes:
                ...
                if len(collective_processes) >= 8:
                    ...
                    print(f"⚠️  PARTIAL SUCCESS: {len(collective_processes)}/8 terminals running")
                    print("Some terminals may have failed to start")
                    print()
                    print("💡 Try launching the missing terminals manually:")
                    print("   cd /Users/Arief/Desktop/Nexus/forensic_reconciliation_app/ai_service/taskmaster/core")
                ...
                print("   Open 8 terminal windows and run 'python collective_worker_processor.py' in each")
    ...
    print()
    print("🎯 NEXT STEPS:")
    print("1. If all 8 terminals are running: Monitor with 'python monitor_collective_system.py'")
