...
class RateLimiter:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.enable_distributed_limiting = config.get(
    ...
    async def check_rate_limit(self, client_info: Dict[str, Any], endpoint: str):
    ...
    async def _check_fixed_window(self, client_id: str, rule: RateLimitRule):
    ...
    async def _check_sliding_window(self, client_id: str, rule: RateLimitRule):
    ...
    async def _check_token_bucket(self, client_id: str, rule: RateLimitRule):
        ...
        try:
            ...
            current_tokens = min(
                bucket_capacity, state.current_requests + tokens_to_add
            )
    ...
    async def _check_leaky_bucket(self, client_id: str, rule: RateLimitRule):
    ...
    async def _check_adaptive(self, client_id: str, rule: RateLimitRule):
        ...
        while True:
            try:
                ...
                for client_id, rule_id in expired_clients:
                    if (
                        client_id in self.client_states
                        and rule_id in self.client_states[client_id]
                    ):
                    ...
                    if (
                        client_id in self.client_states
                        and not self.client_states[client_id]
                    ):
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "rate_limit_strategies_supported": [
