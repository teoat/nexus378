...
class SMSService:
    ...
    def __init__(
        self, code_length: int = 6, expiry_minutes: int = 10, max_attempts: int = 3
    ):
    ...
    def verify_sms_code(self, code_id: str, code: str) -> Tuple[bool, str]:
        ...
        return (
            False,
            f"Invalid SMS code. {sms_code.attempts_remaining} attempts remaining",
        )
...
sms_service = SMSService(code_length=6, expiry_minutes=10, max_attempts=3)
