...
def main():
    ...
    assigned_tasks = [
        todo for todo in registry.priority_todos if todo["assigned_agent"] is not None
    ]
    unassigned_tasks = [
        todo for todo in registry.priority_todos if todo["assigned_agent"] is None
    ]
    ...
    if assigned_tasks:
        ...
        print(
            "These tasks should not be implemented by other agents to prevent overlaps.",
        )
