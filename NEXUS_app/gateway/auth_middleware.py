...
class AuthMiddleware:
    ...
    def _initialize_default_permissions(self):
        ...
        try:
            ...
            self.logger.info(
                f"Default permissions initialized: {len(all_permissions)} permissions"
            )
    ...
    async def authenticate_user(
        ...
        try:
            ...
            session = UserSession(
                ...
                + timedelta(seconds=self.access_token_expiry),
    ...
    async def _record_failed_attempt(self, username: str, ip_address: str = None):
        ...
        try:
            ...
            if len(self.failed_attempts[username]) >= self.max_failed_attempts:
                ...
                self.logger.warning(
                    f"Account {username} locked due to multiple failed attempts"
                )
    ...
    async def _cleanup_failed_attempts(self):
        ...
        while True:
            try:
                ...
                expired_lockouts = [
                    username
                    for username, lockout_time in self.locked_accounts.items()
                ...
                if expired_lockouts:
                    self.logger.info(
                        f"Cleaned up {len(expired_lockouts)} expired lockouts"
                    )
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (
                self.successful_auths / self.total_auth_attempts
