#!/usr/bin/env python3
Proper Tab-Based Terminal Launcher - Creates ONE window with multiple tabs

This script properly creates tabs within a single Terminal.app window instead of
opening separate windows for each worker.

import os
import time

def launch_proper_tabs():
